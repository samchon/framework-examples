    ...
    (function (chat) {
        var ChatApplication = (function (_super) {
            ...
            function ChatApplication(uid) {
                ...
                _this.messages = "";
                _this.room = new chat.ChatRoom();
                _this.communicator = new chat.protocol.WebServerConnector(_this);
                _this.communicator.connect(chat.SERVER_HOST, chat.SERVER_PORT, "chat/" + uid);
                return _this;
            }
            /* =========================================================
                INVOKE MESSAGE CHAIN
    ...
    (function (chat) {
        var ListApplication = (function (_super) {
            ...
            function ListApplication() {
                var _this = _super.call(this) || this;
                _this.room_name_tabs = []; /* 채팅방 탭 제목 배열 */
                _this.room_tabs = []; /* 채팅방 탭 내용 배열 */
                _this.room_list = new chat.ChatRoomList();
                _this.communicator = new chat.protocol.WebServerConnector(_this);
                _this.communicator.connect(chat.SERVER_HOST, chat.SERVER_PORT, "list");
                return _this;
            }
            /* =========================================================
                INVOKE MESSAGE CHAIN
